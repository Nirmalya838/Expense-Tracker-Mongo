...
const ForgetPassword = require('../models/forgetpassword'); // Make sure to import your Mongoose model
  ...
  try {
    ...
    if (user) {
      ...
      const msg = {
        ...
        html: `<a href="http://localhost:3000/password/resetpassword/${forgetpasswordcreate._id}">Click to Reset Password</a>`,
      };
